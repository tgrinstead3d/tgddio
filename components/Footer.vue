...
const socialLinks = [
    ...
    {
        name: 'LinkedIn',
        url: 'https://linkedin.com/company/tgdesigndevelopment',
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="mb-6 md:mb-0">
                    <img src="/assets/tgdio.webp" alt="TG Design & Development, LLC Logo" class="h-12 invert"
                        loading="lazy">
                </div>
                ...
                <div class="mb-6 md:mb-0 text-center">
                    <p class="text-gray-300">
                        &copy; {{ year }} TG Design & Development, LLC. All rights reserved.
                    </p>
